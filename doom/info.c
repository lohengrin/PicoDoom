...
#ifdef PICO
// See info.h's #ifdef PICO comment on the extern declaration -- the extra
// slot is left off this initializer list on purpose, so C's aggregate-init
// rules zero it (NULL) automatically as a real terminator.
